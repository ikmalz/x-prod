                ...
                <SignIn.Root>
                    ...
                    <SignIn.Step name='start'>
                        <Clerk.Field name="identifier" className='flex flex-col gap-2'>
                            <Clerk.Input placeholder='email@gmail.com' className='py-2 px-6 rounded-full text-black w-72 placeholder:text-sm' />
                    ...
                    <SignIn.Step name='verifications'>
                        <SignIn.Strategy name='password'>
                            ...
                            <div className="flex flex-col gap-2">
                                <SignIn.Action submit className='mt-2 text-sm underline w-72 text-center text-iconBlue'>Continue</SignIn.Action>
                                <SignIn.Action navigate='forgot-password' className='mt-2 text-sm underline w-72 text-center '>Forgot Password?</SignIn.Action>
                            </div>
                        </SignIn.Strategy>
                    ...
                    <SignIn.Step name="forgot-password" className='flex justify-between w-72 txt-sm'>
