            ...
            <div className="w-full lg:w-1/2 flex-col flex gap-4">
                ...
                <SignUp.Root>
                    ...
                    <SignUp.Step name="continue" className='flex flex-col gap-4'>
                        <Clerk.Field name="username" className="py-2 rounded-full text-black w-72 placeholder:text-sm">
                    ...
                    <SignUp.Step name="verifications">
                        <SignUp.Strategy name='email_code'>
                            ...
                            <Clerk.Field name="code" className='flex flex-col gap-4 '>
                                <Clerk.Input placeholder='Verifications code' className="py-2 px-6 rounded-full text-black w-72 placeholder:text-sm" />
                                <Clerk.FieldError className="text-red-300 text-sm" />
                            </Clerk.Field>
