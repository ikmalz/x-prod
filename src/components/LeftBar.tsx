...
const LeftBar = async () => {
    ...
    return (
        <div className="h-screen sticky top-0 flex flex-col justify-between pt-2 pb-8">
            {/* LOGO *MENU BUTTON*/}
            <div className="flex flex-col gap-4 text-sm items-center xxl:items-start">
                {/* LOGO */}
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                    <div className="w-10 h-10 relative rounded-full overflow-hidden">
                        <Image path="/general/avatar.png" alt="ikmal" w={100} h={100} tr={true} />
                    </div>
                    <div className="hidden xxl:flex flex-col">
                        <span className="font-bold">Malzz</span>
                        <span className="text-sm text-textGray">@ikmalaja</span>
                    </div>
                </div>
