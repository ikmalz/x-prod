...
const PostInteractions = ({
    ...
    username: string
    postId: number;
    count: { likes: number; rePosts: number; comment: number },
    isLiked: boolean;
    isRePosted: boolean;
    isSaved: boolean
    ...
    return (
        <div className="flex items-center gap-4 justify-between lg:gap-16 my-2 text-textGray">
            <div className="flex items-center justify-between flex-1">
                ...
                <div className="flex items-center gap-2 cursor-pointer group">
                    ...
                    <span className="group-hover:fill-iconBlue">{count.comment}</span>
                </div>
                {/* REPOST */}
                <form action={rePostAction}>
                    <button className="flex items-center gap-2 cursor-pointer group">
                        ...
                        <span className={`${optimisticCount.isRePosted ? "text-iconGreen" : "text-textGray"} group-hover:text-iconGreen text-sm`}>
                ...
                <form action={likeAction}>
                    <button className="flex items-center gap-2 cursor-pointer group">
                        ...
                        <span className={`${optimisticCount.isLiked ? "text-iconPink" : "text-textGray"} group-hover:fill-iconPink`}>{optimisticCount.likes}</span>
                    </button>
                </form>
            </div>
