...
const Share = () => {
    ...
    const previewURL =
        typeof window !== 'undefined' && media ? URL.createObjectURL(media) : null;
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 flex flex-col gap-4 ">
                ...
                <input type="text" name="desc" placeholder="what is happening?!" className="bg-transparent text-md outline-none placeholder:text-textGray" />
                {/* PREVIEW IMAGE */}
